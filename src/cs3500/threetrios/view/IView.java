...
public interface IView {
  ...
  /**
   * Provides the components of this IView with a ThreeTriosFeatures to handle functionality
   * based on ACtionEvents.
   * @param featuresListener ThreeTriosFeatures to add
   */
